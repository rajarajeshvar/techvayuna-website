...
const DOMAIN_DETAILS: Record<string, { tags: string[]; icon: string; stats: string }> = {
  "Media & Design": { tags: ["Cinematography", "UI/UX", "3D Motion", "Blender"], icon: "ðŸŽ¨", stats: "40+ Productions" },
  "Web Engineering": { tags: ["Next.js", "WebGL", "TypeScript", "Tailwind"], icon: "ðŸŒ", stats: "12+ Live Portals" },
  "Artificial Intelligence": { tags: ["PyTorch", "LLMs", "Computer Vision", "Transformers"], icon: "ðŸ§ ", stats: "98.4% Model Acc" },
  "Data Science": { tags: ["Spark", "Pandas", "ETL", "Predictive ML"], icon: "ðŸ“Š", stats: "10M+ Data Pts" },
  "Cyber Security": { tags: ["PenTesting", "ZeroTrust", "DevSecOps", "CTF"], icon: "ðŸ›¡ï¸", stats: "0 Zero-Days" },
  "Cloud & DevOps": { tags: ["Docker", "Kubernetes", "AWS", "CI/CD"], icon: "â˜ï¸", stats: "99.99% Uptime" },
  "Robotics & Hardware": { tags: ["Arduino", "ESP32", "ROS2", "PCB Design"], icon: "âš™ï¸", stats: "15+ Hardware Prototypes" },
};
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 mb-2">
        <div className="flex items-center gap-2 mb-2.5">
          <span className="px-2.5 py-0.5 text-[10px] font-mono font-bold bg-[var(--theme-primary,rgba(255,94,54,0.15))] text-[var(--theme-primary,#D83A60)] border border-[var(--theme-primary,rgba(255,94,54,0.4))] tracking-widest uppercase">
            SEC_02
          </span>
        ...
        <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-[#0D0B0F]/80 border border-white/10 text-val-gray text-[10px] font-mono">
          <MoveHorizontal className="w-3 h-3 text-[var(--theme-primary,#D83A60)] animate-pulse" />
      ...
      {activeModal && (
        ...
        >
          <div
            className="relative w-full max-w-lg bg-[#14111A] border border-white/20 rounded-2xl overflow-hidden shadow-2xl p-6 select-none"
            onClick={(e) => e.stopPropagation()}
            style={{
              borderColor: "var(--theme-primary, #D83A60)",
          ...
          >
            ...
            <div className="flex items-start justify-between mb-4">
              <div>
                <span className="px-2 py-0.5 text-[10px] font-mono tracking-widest text-[var(--theme-primary,#D83A60)] border border-[var(--theme-primary,#D83A60)]/30 rounded uppercase">
            ...
            <div className="mb-5">
              <div className="text-[10px] font-mono uppercase text-val-gray mb-2 flex items-center gap-1.5">
                <Tag className="w-3 h-3 text-[var(--theme-primary,#D83A60)]" />
            ...
            <div className="pt-4 border-t border-white/10 flex items-center justify-between">
              ...
              <button
                onClick={() => setActiveModal(null)}
                className="px-4 py-2 rounded-lg bg-[var(--theme-primary,#D83A60)] text-black text-xs font-mono font-bold tracking-wider uppercase hover:opacity-90 transition-opacity flex items-center gap-1.5 cursor-pointer"
              >
